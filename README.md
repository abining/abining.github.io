...
tags:
  ...
  - Right
---
## 举例一个，下面是使用post这个布局（常用来写文章），头部的样式是text，设置分组到Map组，最终文章的路径是https://<domain>/Map/<YYYY>/<MM>/<DD>/<title>
---
layout: post
...
看右边:
![20241127000137](https://raw.githubusercontent.com/abining/picgo_imgs/main/images/20241127000137.png)
...
侧边栏是响应式布局的，当屏幕尺寸小于 992px 的时候，侧边栏就会移动到底部。具体请见 bootstrap 栅格系统 [http://v3.bootcss.com/css/](http://v3.bootcss.com/css/)
...
![](http://abining.github.io/img/blog-keynote.jpg)
...
> Ebin 的博客，fork 自[Hux Blog](https://github.com/Huxpro/huxpro.github.io)
