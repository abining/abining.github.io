...
tags:
    ...
    - 面试
---
![CSS.png](https://s2.loli.net/2024/11/17/DM8TlgvXjmNP3rf.png)
...
![20200715170121834.png](https://s2.loli.net/2024/11/17/98vzuL4nRKaUsmG.png)
![20200715170108916.png](https://s2.loli.net/2024/11/17/mZVRo8t94IJ6s71.png)
...
![img](https://s2.loli.net/2024/11/17/wJ6IiVAOvlDx9ra.jpg)
...
![5ee2df9e0001fdcf12580304.png](https://s2.loli.net/2024/11/17/2cuNwoeIzk6xM8V.png)
...
![5ee2df9500016ef112620300.png](https://s2.loli.net/2024/11/17/H9KWt65mMIUxGTy.png)
...
![20200605165714817.png](https://s2.loli.net/2024/11/17/gbyYAh7RE9Mwdlv.png)
...
![5e586ba000016e3a16001478.jpg](https://s2.loli.net/2024/11/17/vsERBtyN1fk7q85.png)
...
![aHR0cHM6Ly91c2VyLWdvbGQtY2RuLnhpdHUuaW8vMjAxOC8yLzIzLzE2MWMxMDY2YTViODNhZTg.png](https://s2.loli.net/2024/11/17/DmZJNqdo8Rr6Qij.png)

**fixed：**元素的定位是相对于 window （或者 iframe）边界的，和其他元素没有关系。但是它具有破坏性，会导致其他元素位置的变化。

![aHR0cHM6Ly91c2VyLWdvbGQtY2RuLnhpdHUuaW8vMjAxOC8yLzIzLzE2MWMxMDY2YWI4NTY3MjE.png](https://s2.loli.net/2024/11/17/f6xy7mwOXS9ba41.png)

**absolute：**元素的定位相对于前两者要复杂许多。如果为 absolute 设置了 top、left，浏览器会根据什么去确定它的纵向和横向的偏移量呢？答案是浏览器会递归查找该元素的所有父元素，如果找到一个设置了 `position:relative/absolute/fixed`的元素，就以该元素为基准定位，如果没找到，就以浏览器边界定位。如下两个图所示：
![aHR0cHM6Ly91c2VyLWdvbGQtY2RuLnhpdHUuaW8vMjAxOC8yLzIzLzE2MWMxMDY2YWQ0ZmZjNjM.png](https://s2.loli.net/2024/11/17/peM1UPoZJOgY6ki.png)

![aHR0cHM6Ly91c2VyLWdvbGQtY2RuLnhpdHUuaW8vMjAxOC8yLzIzLzE2MWMxMDY2YjQxOWNmZTY.png](https://s2.loli.net/2024/11/17/WB5OvgTp7cedGQk.png)
...
![20200818221448188.png](https://s2.loli.net/2024/11/17/wE3L7JrYze2nI1i.png)
...
![20200818222156852.png](https://s2.loli.net/2024/11/17/loyaDAOkB3F9zjh.png)
...
![2020081822434193.png](https://s2.loli.net/2024/11/17/NHFypsPMRt3DUi9.png)
...
<img style="display: block; margin: 0 auto;"  src = "https://s2.loli.net/2024/11/17/zmtBFUA93cW1Tsv.png" alt="h">
...
可以先在 JS 中拿到 window.devicePixelRatio 的值，然后把这个值通过 JSX 或者模板语法给到 CSS 的 data 里，达到这样的效果（这里用 模板语法 做示范）：

```html
<div id="container" :data-device=Var-window.devicePixelRatio></div>
```
