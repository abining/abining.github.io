...
![性能优化面试题.png](https://s2.loli.net/2024/11/18/8nBGjsSWq47fZJl.png)
...
![img](https://s2.loli.net/2024/11/18/8HxP2BFSzmi1g3U.png)
...
![20200605165714817 (1)](https://raw.githubusercontent.com/abining/picgo_imgs/main/images/20200605165714817%20(1).png)
...
function throttle (fun, wait){
  // 定时器的特性：如果定时器还在运行，定时器的返回值就是falsy
  let timeout = null
  return function(){
    let context = this
    let args = [...arguments]
